...
public class HtmlTagHandler implements Html.TagHandler {
    ...
    public void handleTag(final boolean opening, final String tag, Editable output, final XMLReader xmlReader) {
        if (opening) {
            ...
            if (RealTextView.DEBUG) {
                Log.d(RealTextView.TAG, "opening, output: " + output.toString());
            }
            ...
            // closing tag
            if (RealTextView.DEBUG) {
                Log.d(RealTextView.TAG, "closing, output: " + output.toString());
            }
            ...
            if (tag.equalsIgnoreCase("ul")) {
                ...
                end(output, Center.class, false, new AlignmentSpan.Standard(Layout.Alignment.ALIGN_CENTER));
            } else if (tag.equalsIgnoreCase("s") || tag.equalsIgnoreCase("strike")) {
    ...
    private void start(Editable output, Object mark) {
        ...
        if (RealTextView.DEBUG) {
            Log.d(RealTextView.TAG, "len: " + len);
        }
    }
    ...
    private void end(Editable output, Class kind, boolean paragraphStyle, Object... replaces) {
        ...
        if (where != len) {
            ...
            if (RealTextView.DEBUG) {
                Log.d(RealTextView.TAG, "where: " + where);
                Log.d(RealTextView.TAG, "thisLen: " + thisLen);
            }
        }
    }
